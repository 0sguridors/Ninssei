<section class="category" id="category">
    ...
    <?php
    $contador = 1;
    $pesquisar = array_key_exists('pesquisa', $_POST) ? $_POST['pesquisa'] : NULL;
    $query = "SELECT produtos.id_produto, produtos.nome, produtos.preco_venda, produtos.desconto, produtos.arqimagem FROM produtos ";
    if($pesquisar){
